            ...
            , vscode.commands.registerCommand(cs.dynamics.controls.dynamicsTreeView.addEntry, async (item: TreeEntry) => { // Match name of command to package.json command
                ...
                switch (item.itemType) {
                    ...
                    case "PluginType":
                        ...
                        break;
                    case "PluginStep":
                        vscode.commands.executeCommand(cs.dynamics.controls.pluginStepImage.open, context, item.context.sdkmessageprocessingstepid, null, item.config);
                        break;
                }
            })   
            , vscode.commands.registerCommand(cs.dynamics.controls.dynamicsTreeView.editEntry, async (item: TreeEntry) => { // Match name of command to package.json command
                ...
                switch (item.itemType)
                {
                    ...
                    case "PluginStep":
                        ...
                        break;
                    case "PluginStepImage":
                        vscode.commands.executeCommand(cs.dynamics.controls.pluginStepImage.open, context, item.context._sdkmessageprocessingstepid_value, item.context, item.config);
                        break;
                }
           }) 
