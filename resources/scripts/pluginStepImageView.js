...
(function() {
    ...
    $(function () {
        function validateForm(pluginStepImage) {
            ...
            if (CloudSmith.Utilities.$Object.IsNullOrEmpty(pluginStepImage.sdkmessageprocessingstepid)) { messages.push('The sdkmessageprocessingstepid is required'); }
            if (pluginStepImage.imagetype === null) { messages.push('The Image Type is required'); }
            if (CloudSmith.Utilities.$Object.IsNullOrEmpty(pluginStepImage.name)) { messages.push('The Name is required'); }
            if (CloudSmith.Utilities.$Object.IsNullOrEmpty(pluginStepImage.entityalias)) { messages.push('The Entity Alias is required'); }
            if (CloudSmith.Utilities.$Object.IsNullOrEmpty(pluginStepImage.attributes)) { messages.push('The Parameters is required'); }
