...
(function () {
    ...
    function autocomplete(inp, arr) {
      ...
      /*An array containing all the messages:*/
      var message = [viewModel.name, viewModel.sdkMessage.name];
      
      /*initiate the autocomplete function on the "myInput" element, and pass along the message array as possible autocomplete values:*/
      autocomplete(document.getElementById("myInput"), message);
