...
* [PluginType](_api_cdssolutions_.cdssolutions.solutioncomponent.md#plugintype)
...
Defined in src/api/CdsSolutions.ts:61
...
Defined in src/api/CdsSolutions.ts:57
...
Defined in src/api/CdsSolutions.ts:119
